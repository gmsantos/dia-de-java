            ...
            <header class="wrapper clearfix">
                ...
                <nav class="wrapper clearfix">
                    <ul>
                        ...
                        <li><a href="certificado" class="active">Certificado</a></li>
                    </ul>
                </nav>
            </header>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="emitirCertificado?participante=<%= rs.getString(1) %>">Emitir Certificado</a></td>
                            </tr>
